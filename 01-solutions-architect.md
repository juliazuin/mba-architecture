...
![triangulo-ecosistema-enterprise.png](./img/01/triangulo-ecosistema-enterprise.png)
...
3 níveis de arquitetura de solucao:
0  - arquitetura focada no negócio - como resolver o problema, requisitos funcionais e não funcionais, como funcionará na empresa, quantas pessoas vão utilizar


1 - arquitetura focada na área técnica - como vai ser desenvolvido, técnologias, integrações, custos, desenvolvedores..
2 - arquitetura focada no deployment - como vai ser entregue a solução 